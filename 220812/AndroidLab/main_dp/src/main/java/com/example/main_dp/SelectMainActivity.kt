...
//                searchmain.setOnEditorActionListener { textView, i, keyEvent ->
//                        if(i == EditorInfo.IME_ACTION_SEARCH){
//                                val inputName = EditorInfo.IME_ACTION_SEND
//
//                                true
//                        }
//                        false
//                } 검색버튼 누르면 바로 다이얼로그 뜨게하기
                ...
                breadButton.setOnClickListener {
                        val intent = Intent(this, Datafun::class.java)
                        startActivity(intent)
                }
