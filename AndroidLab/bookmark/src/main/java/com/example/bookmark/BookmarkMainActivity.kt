...
import kotlinx.android.synthetic.main.activity_main_bookmark.*
...
class BookmarkMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val aBookmarkAdapter = BookmarkAdapter(this, FoodList)
        recyclerView.adapter = aBookmarkAdapter
...
//        파이어스토어 북마크 id, img_url 받기
        ...
        val db_sqlite = BookmarkDataBaseHelper(this).readableDatabase
